...
NOTARIZE_BUNDLE_ID=com.unevens.Curvessor
NOTARIZE_BUNDLE_ID_DEMO=com.unevens.Curvessor.DEMO
...
#if [ $DEMO == 1 ]
#then
#  git checkout installer/Curvessor.iss
#  git checkout installer/Curvessor.pkgproj
