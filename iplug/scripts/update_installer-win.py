...
# WIN INSTALLER
  ...
  for line in fileinput.input(projectpath + "/installer/" + config['BUNDLE_NAME'] + ".iss",inplace=1):
    ...
    if "OutputBaseFilename" in line:
      if demo:
        line="OutputBaseFilename=Curvessor Demo Installer\n"
      else:
        line="OutputBaseFilename=Curvessor Installer\n"
    ...
    if "WelcomeLabel1" in line:
     if demo:
       line="WelcomeLabel1=Welcome to the Curvessor Demo installer\n"
     else:
       line="WelcomeLabel1=Welcome to the Curvessor installer\n"
       
    if "SetupWindowTitle" in line:
     if demo:
       line="SetupWindowTitle=Curvessor Demo installer\n"
     else:
       line="SetupWindowTitle=Curvessor installer\n"
